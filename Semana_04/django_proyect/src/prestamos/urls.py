...
urlpatterns = [
    ...
    path("autorizaciones/", views.autorizacion_list, name="autorizacion_list"),
    path("autorizaciones/nuevo/", views.autorizacion_create, name="autorizacion_create"),
    path(
        "autorizaciones/<int:pk>/editar/",
        views.autorizacion_update,
        name="autorizacion_update",
    ),
    path(
        "autorizaciones/<int:pk>/eliminar/",
        views.autorizacion_delete,
        name="autorizacion_delete",
    ),
]
